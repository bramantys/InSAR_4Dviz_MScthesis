...
REPORT_TXT_OUT = RUN_RECORDS / "phase14a_parcel_color_scales_report.txt"
REPORT_JSON_OUT = RUN_RECORDS / "phase14a_parcel_color_scales_report.json"
...
def main() -> None:
    ...
    print("\n=== PROTO2 PHASE 14A: PARCEL COLOR SCALES ===")
    ...
    # Displacement components do not have per-epoch sigma_h yet, so do not fake uncertainty-derived tau.
    # Use a fixed small mm deadband around datum.
    ...
    scales = {
        ...
        "reversible_displacement": derive_generic_scale(
            ...
            tau_source="fixed ±1.0 mm deadband because sigma_h(t) is not available yet",
        ),
    ...
    payload = {
        ...
        "generated_by": "14_build_parcel_color_scales.py",
        ...
        "scales": scales,
        "notes": [
            "Color scales are fixed over the whole 2025 epoch range; they do not rescale per epoch.",
            ...
            "Per-epoch displacement uncertainty sigma_h(t) is unavailable, so displacement tau uses a fixed ±1 mm deadband.",
        ],
    }
    ...
    summary = {
        "product": "proto2_phase14a_parcel_color_scales",
    ...
    lines = [
        "PROTO2 PHASE 14A PARCEL COLOR SCALES REPORT",
        "",
    ...
    print("\nPHASE 14A RESULT: PASS. Parcel color-scale products written.")
