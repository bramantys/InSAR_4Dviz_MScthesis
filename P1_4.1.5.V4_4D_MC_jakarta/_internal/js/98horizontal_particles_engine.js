// ============================================================
// HORIZONTAL PARTICLES ENGINE — V4.2 canvas uncertainty diagnostics
// ============================================================
...
// V4.2 adds Monte Carlo diagnostics and optional seeded reproducibility.
...
function updateHorizontalLegendLabels() {
    ...
    if (hLegendRightText) {
        if (hParticleUncertaintyMode === "montecarlo") {
            ...
            hLegendRightText.textContent = `Velocity realization | scale ${hUncertaintyStrength.toFixed(2)} | ${seedTxt}`;
...
function hParticleMotionField(field, particle) {
    ...
    const offsetSpeed = Math.sqrt(offset.east * offset.east + offset.north * offset.north) * scale;
